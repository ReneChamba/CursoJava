...
public class J5_Stream3_Buffers {
	 ...
	 * 
	 *   Lo mismo sucede cuando deseamos escribir, primero los datos a escribir de vuelcan a buffer y luego ser�
...
class UtilizarBUffer{
	...
	public static void bufferedEscribir()  throws Exception{
		...
		String textoEscribir="ESto es informaci�n escrita desde java  utilizando la clase BufferedWriter ";
